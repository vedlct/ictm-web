                    ...
                    <body>
                      <table>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>Hear:</td><td>'.$hear.'</td>
                        </tr>
                         <tr>
                          <td>Other:</td><td>'.$other.'</td>
                        </tr>
                         <tr>
                          <td>Disability:</td><td>'.$disability.'</td>
                        </tr>
                         <tr>
                          <td>Appoinment Date:</td><td>'.$appoinment.'</td>
                        </tr>
                         <tr>
...
//                $headers[] = 'To: <'.ADMIN_EMAIL.'>';
                $headers[] = 'From: <'.$email.'>';
                $headers[] = 'Cc:  info@iconcollege.ac.uk';
...
//                // Additional headers
//                $headers[] = 'From: '.$email;
//                $headers[] = 'Cc: anis@iconcollege.ac.uk';
//                $headers[] = 'Bcc: md.sakibrahman@gmail.com';
