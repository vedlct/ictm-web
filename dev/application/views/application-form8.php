...
<!--                            </div>-->
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-md-10">
                                    ...
                                    <button type="submit" formaction="<?php echo base_url()?>ApplyOnline/insertApplicationForm8Save" class="btn btn-next">Save For Later</button>
                                    <button type="submit" formaction="<?php echo base_url()?>ApplyOnline/insertApplicationForm8AndNext" class="btn btn-next">Next</button>
