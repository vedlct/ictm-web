...
<!--                    <fieldset>-->
                        ...
                        <div class="form-bottom">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Institution/Company:<span style="color: red" class="required">*</span></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Position / Job Title:<span style="color: red" class="required">*</span></label>
                                <div class="col-md-9">
    ...
    $(document).ready(function(){
        ...
        $("#addButton").click(function () {
            ...
            newTextBoxDiv.after().html( '<div class="form-group">'+
                '<label class="control-label col-md-3">Title'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
            ...
            '</select>'+
                ...
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Name'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<input type="text" class="form-control" id="name'+counter+'" name="name[]" required >'+
                '</div>'+
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Institution/Company'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<input type="text" class="form-control" id="company'+counter+'" name="company[]" required >'+
                '</div>'+
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Position / Job Title'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<input type="text" class="form-control" id="jobTitle'+counter+'" name="jobTitle[]" required >'+
                '</div>'+
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Telephone'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<input type="text" class="form-control" id="telephone'+counter+'" name="telephone[]" required >'+
                '</div>'+
                '</div>'+'<div class="form-group">'+
                '<label class="control-label col-md-3">E-mail'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<input type="email" class="form-control" id="email'+counter+'" name="email[]" required >'+
                '</div>'+
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Address'+counter+':<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
                '<textarea id="address'+counter+'" name="address[]" rows="8"  required tabindex="4"></textarea>'+
                '</div>'+
                '</div>'+
                '<div class="form-group">'+
                '<label class="control-label col-md-3">Address P.O :<span style="color: red" class="required">*</span></label>'+
                '<div class="col-md-9">'+
