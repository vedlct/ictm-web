                                            ...
                                            <?php $count=0; foreach($opportunitySubGroupId as $osg){ ?>
                                                <?php if ($osg->fkGroupId == $a6->id) { ?>
                                                    ...
                                                    <?php if ($count % 2 ==0) { ?>
                                                        ...
                                                        <tr>
                                                    <?php } ?>
                                                    <td ><input type = "radio" name = "check_list" <?php if($osg->id==$EO->id){ echo "checked=checked";}?> value = "<?php echo $osg->id?>" > <?php echo $osg->subGroupTitle?></td >
                                                    ...
                                                    <?php $count=0; foreach($opportunitySubGroupId as $osg){ ?>
                                                        <?php if ($osg->fkGroupId == $a6->id) { ?>
                                                            ...
                                                            <?php if ($count % 2 ==0) { ?>
                                                                ...
                                                                <tr>
                                                            <?php } ?>
                                                            <td ><input type = "radio" name = "check_list1" <?php if($osg->id==$EO->id){ echo "checked=checked";}?> value = "<?php echo $osg->id?>" > <?php echo $osg->subGroupTitle?></td >
                                                            <!--                                                <td ><input type = "radio" name = "check_list" value = "--><?php //echo $osg->subGroupTitle?><!--" > --><?php //echo $osg->subGroupTitle?><!--</td >-->
                                                            <?php if ($count % 2 !=0) { ?>
                                                                </tr>
                                                            <?php } ?>
                                            ...
                                            <?php $count=1; foreach($opportunitySubGroupId as $osg){ ?>
                                                <?php if ($osg->fkGroupId == $a6->id) { ?>
                                                    ...
                                                    <?php if ($count % 2 ==0) { ?>
                                                        ...
                                                        <tr>
                                                    <?php }?>
                                                    <td ><input type = "radio" name = "check_list2" <?php if($osg->id==$EO->id){ echo "checked=checked";}?> value = "<?php echo $osg->id?>" > <?php echo $osg->subGroupTitle?></td >
                                                    <!--                                                <td ><input type = "radio" name = "check_list" value = "--><?php //echo $osg->subGroupTitle?><!--" > --><?php //echo $osg->subGroupTitle?><!--</td >-->
                                                    <?php if ($count % 2 !=0) { ?>
                                                        </tr>
                                                    <?php } ?>
                                            ...
                                            <?php $count=0; foreach($opportunitySubGroupId as $osg){ ?>
                                                <?php if ($osg->fkGroupId == $a6->id) { ?>
                                                    ...
                                                    <?php if ($count % 2 ==0) { ?>
                                                        ...
                                                        <tr>
                                                    <?php } ?>
                                                    <td ><input type = "radio" name = "check_list3" <?php if($osg->id==$EO->id){ echo "checked=checked";}?> value = "<?php echo $osg->id?>" > <?php echo $osg->subGroupTitle?></td >
                                                    <!--                                                <td ><input type = "radio" name = "check_list" value = "--><?php //echo $osg->subGroupTitle?><!--" > --><?php //echo $osg->subGroupTitle?><!--</td >-->
                                                    <?php if ($count % 2 !=0) { ?>
                                                        </tr>
                                                    <?php } ?>
