...
<section class="flat-row padding-small-v1">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form role="form" action="<?php echo base_url()?>Login/changeForgetPassword" method="post"  class="registration-form">

                    <div class="form-bottom">
                        <div class="form-group">
                            <label>E-Mail*</label>
                            <input type="email" name="useremail" placeholder="Your Email" class="form-first-name form-control" id="form-first-name">
                        </div>
                        <div class="form-group">
                            <label>New Password*</label>
                            <input type="password" name="password" placeholder="Your New Password" class="form-last-name form-control" id="form-last-name">
                        </div>


                        <button type="submit" class="btn btn-next">Change</button>


                        <a href="<?php echo base_url()?>Login"class="pull-right"><i class="mdi mdi-lock"></i>Allready Have an Account?</a>
