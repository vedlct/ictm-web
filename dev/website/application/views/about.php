                                        ...
                                        <div class="content-pad single-course-detail">
                                                <div class="content-content">
                                                                ...
                                                                <ul style="margin-left:0px" class="nav nav-tabs">
                                                                    <li class="active"><a href="#tab1" data-toggle="tab">About ICON College</a></li>
																	<li><a href="#tab2" data-toggle="tab">Our Vision & Mission</a></li>
                                                                    <li><a href="#tab3" data-toggle="tab">Why choose ICON College</a></li>
                                                                    <li><a href="#tab4" data-toggle="tab">Where are we</a></li>
                                                                </ul>
