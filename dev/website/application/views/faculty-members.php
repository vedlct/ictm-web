                                        ...
                                        <div class="item">
                                            <div class="thumb-item">
                                                <div   class="item-thumbnail">
                                                    ...
                                                    <a href="faculty-member-detail.php"><img height="360px" width="360px" src="<?php echo base_url()?>../<?php echo FOLDER_NAME ?>/images/facultyImages/<?php echo $listOfFaculty->facultyImage?>" alt="image"></a>
                                                    <?php }else{?>
                                                ...
                                                <div class="item-content">
                                                    ...
                                                    <ul class="list-inline social-light">
                                                        <li><a class="btn btn-default social-icon" href="<?php echo $listOfFaculty->facultyTwitter;?>"><i class="fa fa-twitter"></i></a></li>
                                                        <li><a class="btn btn-default social-icon" href="<?php echo $listOfFaculty->facultyLinkedIn;?>"><i class="fa fa-linkedin"></i></a></li>
                                                        <li><a class="btn btn-default social-icon" href="<?php echo $listOfFaculty->facultyEmail;?>"><i class="fa fa-envelope"></i></a></li>
                                                    </ul>
                                                </div><!-- /item-content -->
                                            </div><!-- /thumb-item -->
                                        </div><!-- /item -->
