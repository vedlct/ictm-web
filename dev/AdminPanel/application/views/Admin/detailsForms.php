<!DOCTYPE html><html lang="en"><head>
    ...
    <div style= "background: #fff; margin-bottom: 30px;padding: 25px "  class="container">
        ...
        <table style="width:100%">
            <?php foreach ($personalDetails as $pd) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" <?php if ($pd->ganderChange =="Y") {?> checked <?php } ?> > Yes
                        <input type="checkbox" <?php if ($pd->ganderChange =="N") {?> checked <?php } ?> > No
                        <input type="checkbox" <?php if ($pd->ganderChange =="PNS") {?> checked <?php } ?> > Prefer Not to say
                    </td>
                </tr>
                <tr>
        ...
        <table style="width:100%;">
            ...
            <?php } ?>
            <?php foreach ($languageProficiency as $lp2) {   ?>
                <tr>
                    <td>Other (Please specify)</td>
                    <td colspan="6"><?php echo $lp2->other ?></td>
                </tr>
            <?php } ?>
        </table>
        ...
        <table border="0" style="width:100%; margin-top: 20px;">
            <?php foreach ($applicationDetails as $appDetails) { ?>
            <tr >
                <td style="width: 25%;"><b>Applicants Signature</b></td>
                <td style="width: 25%;">&nbsp;<br>&nbsp;<br>&nbsp;</td>
                <td style="width: 25%;"><b>Date of Application</b></td>
                <td style="width: 25%;"><?php if ($appDetails->applyDate != null){echo date('Y-m-d', strtotime($appDetails->applyDate));} ?></td>
            </tr>
            <?php } ?>
        </table>
        ...
        <table border="0" style="width:100%; margin-top: 50px;page-break-before: always">
            <tr style="background: #B0DBF0;">
