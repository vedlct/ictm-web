...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-files-o"></i> New &nbsp Album</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="<?php echo base_url()?>Admin/Home">Home</a></li>
                        <li><i class="icon_document_alt"></i>Album</li>
                        <li><i class="fa fa-files-o"></i>Create a New Album</li>
                    </ol>
                </div>
            </div>
            <!-- Form validations -->
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="form-validate form-horizontal" id="CreateNewAlbum" method="POST" action="<?php echo base_url() ?>Admin/Album/createNewAlbum" onsubmit="return formvalidate()">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input class="form-control" id="albumCategory" name="albumCategory"  value="<?php echo set_value('albumCategory'); ?>" type="text" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input class="form-control" id="albumTitle" name="albumTitle"  value="<?php echo set_value('albumTitle'); ?>" type="text" required />
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <select class="form-control m-bot15" name="albumStatus" id="albumStatus" required>
                                                ...
                                                <?php for ($i=0;$i<count(STATUS);$i++){?>
                                                    <option <?php echo set_select('albumStatus',  STATUS[$i], False); ?>><?php echo STATUS[$i]?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
