                ...
                <div class="row">
                    <div class="col-md-12">                    
                        <div class="page-title-heading">
                            <h2 class="title">Course Title: HND in Business<br><span style="font-size:16px">Course Code: TNA67</span></h2>
                        </div>
                ...
                <div class="content-course">
                    <div class="row">
                        ...
                        <ul style="margin-left:0px" class="nav nav-tabs">
                            <li class="active"><a href="#tab1danger" data-toggle="tab">Course Overview</a></li>
                            <li><a href="#tab2danger" data-toggle="tab">Progression</a></li>
                            <li><a href="#tab3danger" data-toggle="tab">Course Structure</a></li>
                            <li><a href="#tab4danger" data-toggle="tab">Entry Requirements</a></li>
                            <li><a href="#tab5danger" data-toggle="tab">Semester Structure</a></li>
                            <li><a href="#tab6danger" data-toggle="tab">Teaching & Learning</a></li>
                            <li><a href="#tab7danger" data-toggle="tab">Assessment & Feedback</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab2danger">
                        	<div class="course-detail-section">
                            	<h3>Progression</h3>
                                <p>The Level 5 Higher National Diploma allows students to specialise by committing to specific career paths and progression routes to degree-level study. </p>
                        ...
                        <div class="tab-pane fade" id="tab3danger">
                        	<div class="course-detail-section">
                            	<h3>Course Structure/Unit Details</h3>
                                <p>This course consists of 15 units (8 core units + 7 optional units) including a Project. There are 60 learning hours for each unit and 120 learning hours for the Project.</p><br>
                        ...
                        <div class="tab-pane fade" id="tab4danger">
                        	<div class="course-detail-section">
                                ...
                                <p>To meet the entry criteria for admission to level 5 HND Courses:</p>
                        ...
                        <div class="tab-pane fade" id="tab5danger">
                        	<div class="course-detail-section">
                            	<h3>Module Information/Semester Structure</h3>
                                <div class="table-responsive">
                                                        	<table class="table table-bordered">
                                                            	<thead>
                                                                	<tr>
                        ...
                        <div class="tab-pane fade" id="tab7danger">
                        	<div class="course-detail-section">
                                ...
                                <p>The College adheres to the adopted assessment policies and procedures that are published in the Quality and Enhancement Manual (QAEM) which is in line with the UK Quality Code. Effective assessment rests with the purpose for which the assessment is carried out as well as the nature and type of appropriate assessment tools used. In essence the assessment materials and tools should be fit-for-purpose. The college assessor and internal verifier assured that assignment brief of the assignments are fair and accurate as much as possible.</p>
                                                        ...
                                                        <p>The College uses both formal and informal assessment strategies. The College uses a variety of assessment methods to enhance learning and improves the validity of assessment. The assessment methods improve the knowledge of the assessment criteria and what is required to gain higher grade achievement. There is a range of assessment methods that are  utilised, such as: presentations; written reports.  As an informal assessment strategy, the College implements a formative method of assessment which requires students to submit ‘task by task’ coursework during the semester.</p>
                        ...
                        <div class="tab-pane fade" id="tab9danger">
                        	<div class="course-detail-section">
                                ...
                                <p><strong>Knowledge and understanding</strong></p>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>Developing appropriate policies and strategies within a changing environment to meet stakeholders’ interest and the use of risk management techniques. </li>
                        ...
                        <div class="tab-pane fade" id="tab10danger">
                        	<div class="course-detail-section">
                            	<h3>Relevant External Reference Points</h3>
                                <ul>
                                                        ...
                                                        <div class="cr-content">
                                                            <div class="row">
                                                                <div class="col-md-6 col-sm-6 related-item">
                                                                    <div class="thumb">
                                                                        <a href="#">
                                                                            <img src="images/about/index1/course/single/4.jpg" alt="image">
                                                                            <div class="overlay"></div>
                                                                        </a>
                                                                    </div>
                                                                    <div class="cr-title">
                                                                        <a href="#" class="related-cr-title main-color-1-hover">Bachelor Of Nursing</a>
                                                                    </div>
                                                                    <div class="cr-start small-text">July 24, 2015</div>
                                                                    <div class="clear"></div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6 col-sm-6 related-item">
                                                                    <div class="thumb">
                                                                        <a href="#">
                                                                            <img src="images/about/index1/course/single/5.jpg" alt="image">
                                                                            <div class="overlay"></div>
                                                                        </a>
                                                                    </div>
                                                                    <div class="cr-title">
                                                                        <a href="#" class="related-cr-title main-color-1-hover">Chemical Engineering</a>
                                                                    </div>
                                                                    <div class="cr-start small-text">December 25, 2015</div>
                                                                    <div class="clear"></div>
                                                                </div>
                                                            </div>
                                                       </div>
                            ...
                            <div class="sidebar">
                            	...
                            	<div class="table-responsive">
                                	<table class="table table-bordered">
                                    	...
                                    	<tbody>
                                        	<tr>
                                        		<td><strong>Award:</strong>  BTEC Level 5 HND in Business - RQF</td>
                                            </tr>
                                            <tr>
                                                <td><strong>UCAS Code:</strong> ICON0001</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Location:</strong> ICTM</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Awarding body:</strong>  Pearson</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Credit Value:</strong> 240 credits, levels 4 and 5.  </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Course Structure:</strong> 14 X 15 credits units, 1 X 30-unit research project.</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Accreditation:</strong> Pearson Qualification </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Accreditation No. (QAN):</strong> 601/8365/2</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Duration:</strong> 2 years</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Academic year:</strong> 2017-18</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Mode of Study:</strong> Full Time</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Language of study:</strong> English</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Course Fees*:</strong> £6,000/Yr (UK/EU Student)<br>
                                                    *ICON college reserves the right to alter course fees without prior notice.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Timetables:</strong> Weekend and Evening</td>
                                            </tr>
                                        </tbody>              	
                                    </table>
                                </div>
