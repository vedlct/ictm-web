                                        ...
                                        <div class="content-pad single-course-detail">
                                                <div class="content-content">
                                                                ...
                                                                <ul style="margin-left:0px" class="nav nav-tabs">
                                                                    <li class="active"><a href="#tab1danger" data-toggle="tab">About ICON College</a></li>
                                                                    <li><a href="#tab2danger" data-toggle="tab">Who are we</a></li>
                                                                    <li><a href="#tab3danger" data-toggle="tab">Why choose ICON College</a></li>
                                                                    <li><a href="#tab4danger" data-toggle="tab">Where are we</a></li>
                                                                    <li><a href="#tab5danger" data-toggle="tab">Our Vision & Mission</a></li>
                                                                    <li><a href="#tab6danger" data-toggle="tab">Reason to come at ICON</a></li>
                                                                </ul>
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane fade" id="tab2danger">
                                                                	<div class="content-dropcap">
                                                                    	<p>ICON College is a dynamic and independent Higher Education institution, in the heart of London, providing academic and professional courses of an exceptional standard at competitive prices.</p>
                                                                        ...
                                                                        <p>The College provides high quality teaching and support in a caring and friendly environment. It has all the facilities you will need for an effective and enjoyable learning experience – facilities we believe are vital to your ultimate success.</p>
                                                                ...
                                                                <div class="tab-pane fade" id="tab3danger">
                                                                	<div class="content-pad single-course-detail">
                                                                        <div class="course-detail">
                                                                            <div class="content-content">
                                                                                <h3 id="s1">Quality Teaching and Training</h3>      	
                                                                                <div class="content-dropcap">
                                                                                ...
                                                                                <div id="s2" class="course-detail-section">
                                                                                    ...
                                                                                    <img src="http://www.iconcollege.com/images/pic1.jpg">
                                                                                     
                                                                                </div>
                                                                                
                                                                                <div id="s3" class="course-detail-section">
                                                                                    ...
                                                                                    <img src="http://www.iconcollege.com/images/pic2.jpg">
                                                                                </div>
                                                                                
                                                                                <div id="s4" class="course-detail-section">
                                                                                    ...
                                                                                    <img src="http://www.iconcollege.com/images/pic3.jpg" >
                                                                                </div>
                                                                                
                                                                                <div id="s5" class="course-detail-section">
                                                                                    ...
                                                                                    <img src="http://www.iconcollege.com/images/pic4.jpg" >
                                                                                </div>                              
                                                                            </div><!--/content-content-->
                                                                        </div><!--/course-detail-->
                                                                ...
                                                                <div class="tab-pane fade" id="tab4danger">
                                                                	<div class="content-dropcap">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                            	<img src="http://www.iconcollege.com/images/london_docklands.JPG">	
                                                                            </div>
                                                                        </div><br>
                                                                        ...
                                                                        <p>The main East London Mosque, in Whitechapel, is less than 5 minutes walk away from the College, as is several churches. To find out where ICON College is, check out the <a href="#">Travel Guide.</a></p>
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane fade in active" id="tab5danger">
                                                                	<div class="content-dropcap">
                                                                ...
                                                                <div class="tab-pane fade in active" id="tab6danger">
                                                                	<div class="content-dropcap">
                                                                        <ul>
